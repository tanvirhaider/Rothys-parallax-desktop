...
window.parallaxSpeed = 2;
window.topPlacement = -35;
...
function setupDOM() {
  ...
  var header = new Sprite({
    ...
    class: "header-style",
    container: overlay.obj,
    text: {content:"From marine</br>plastic to</br>instant classic."}
  });
  ...
  var subheader = new Sprite({
    ...
    container: overlay.obj,
    text: {content:"Discover a sustainable, chic bag collection knit with 100% recycled materials—including marine plastic—and make a statement about more than just your style."}
  });
    ...
    try {
      ...
      if (msg.type == "ScrollEvent") {
        ...
        if (window.adHeightInformation > 600) {
          ...
          var unitapplied = 100 / percentageinformation * msg.data.data.vPercent * 100; 
        }
